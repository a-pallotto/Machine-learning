...
train['Title'] = train['Title'].apply(title_function)
test['Title'] = test['Title'].apply(title_function)
...
train['Age'] = train['Age'].apply(adult_function)
test['Age'] = test['Age'].apply(adult_function)
